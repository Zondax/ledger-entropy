...
static const char* STR_ME_CHANGE_PROGRAM_MODIFICATION_ACCOUNT = "Change program modification account";
...
static const char* STR_ME_CONFIRM_KEY_RESHARE = "Confirm key reshare";
static const char* STR_ME_JUMP_START_NETWORK = "Jump start network";
static const char* STR_ME_CONFIRM_JUMP_START = "Confirm jump start";
...
static const char* STR_IT_new_program_mod_account = "New program mod account";
...
static const char* STR_IT_version_number = "Version number";
