...
__Z_INLINE parser_error_t _readMethod_system_authorize_upgrade_V8(
    parser_context_t* c, pd_system_authorize_upgrade_V8_t* m)
{
    CHECK_ERROR(_readHash(c, &m->code_hash))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_system_authorize_upgrade_without_checks_V8(
    parser_context_t* c, pd_system_authorize_upgrade_without_checks_V8_t* m)
{
    CHECK_ERROR(_readHash(c, &m->code_hash))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_system_apply_authorized_upgrade_V8(
    parser_context_t* c, pd_system_apply_authorized_upgrade_V8_t* m)
{
    CHECK_ERROR(_readVecu8(c, &m->code))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_utility_dispatch_as_V8(
    parser_context_t* c, pd_utility_dispatch_as_V8_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_balances_force_adjust_total_issuance_V8(
    parser_context_t* c, pd_balances_force_adjust_total_issuance_V8_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_staking_set_staking_configs_V8(
    parser_context_t* c, pd_staking_set_staking_configs_V8_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_staking_force_apply_min_commission_V8(
    parser_context_t* c, pd_staking_force_apply_min_commission_V8_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->validator_stash))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_staking_set_min_commission_V8(
    parser_context_t* c, pd_staking_set_min_commission_V8_t* m)
{
    CHECK_ERROR(_readPerbill(c, &m->new_))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_staking_payout_stakers_by_page_V8(
    parser_context_t* c, pd_staking_payout_stakers_by_page_V8_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->validator_stash))
    CHECK_ERROR(_readEraIndex(c, &m->era))
...
__Z_INLINE parser_error_t _readMethod_staking_update_payee_V8(
    parser_context_t* c, pd_staking_update_payee_V8_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->controller))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_staking_restore_ledger_V8(
    parser_context_t* c, pd_staking_restore_ledger_V8_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->stash))
...
__Z_INLINE parser_error_t _readMethod_stakingextension_change_endpoint_V8(
    parser_context_t* c, pd_stakingextension_change_endpoint_V8_t* m)
{
    CHECK_ERROR(_readVecu8(c, &m->endpoint))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_stakingextension_change_threshold_accounts_V8(
    parser_context_t* c, pd_stakingextension_change_threshold_accounts_V8_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_stakingextension_unbond_V8(
    parser_context_t* c, pd_stakingextension_unbond_V8_t* m)
{
    CHECK_ERROR(_readCompactu128(c, &m->amount))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_stakingextension_chill_V8(
    parser_context_t* c, pd_stakingextension_chill_V8_t* m)
{
    UNUSED(c);
    UNUSED(m);
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_stakingextension_withdraw_unbonded_V8(
    parser_context_t* c, pd_stakingextension_withdraw_unbonded_V8_t* m)
{
    CHECK_ERROR(_readu32(c, &m->num_slashing_spans))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_stakingextension_validate_V8(
    parser_context_t* c, pd_stakingextension_validate_V8_t* m)
{
    CHECK_ERROR(_readValidatorPrefs(c, &m->prefs))
...
__Z_INLINE parser_error_t _readMethod_stakingextension_declare_synced_V8(
    parser_context_t* c, pd_stakingextension_declare_synced_V8_t* m)
{
    CHECK_ERROR(_readbool(c, &m->synced))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_stakingextension_confirm_key_reshare_V8(
    parser_context_t* c, pd_stakingextension_confirm_key_reshare_V8_t* m)
{
    UNUSED(c);
    UNUSED(m);
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_proxy_create_pure_V8(
    parser_context_t* c, pd_proxy_create_pure_V8_t* m)
{
    CHECK_ERROR(_readProxyType(c, &m->proxy_type))
    CHECK_ERROR(_readBlockNumber(c, &m->delay))
...
__Z_INLINE parser_error_t _readMethod_proxy_kill_pure_V8(
    parser_context_t* c, pd_proxy_kill_pure_V8_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_registry_jump_start_network_V8(
    parser_context_t* c, pd_registry_jump_start_network_V8_t* m)
{
    UNUSED(c);
    UNUSED(m);
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_registry_confirm_jump_start_V8(
    parser_context_t* c, pd_registry_confirm_jump_start_V8_t* m)
{
    CHECK_ERROR(_readVerifyingKey(c, &m->verifying_key))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_registry_register_V8(
    parser_context_t* c, pd_registry_register_V8_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_registry_change_program_instance_V8(
    parser_context_t* c, pd_registry_change_program_instance_V8_t* m)
{
    CHECK_ERROR(_readVerifyingKey(c, &m->verifying_key))
...
__Z_INLINE parser_error_t _readMethod_registry_change_program_modification_account_V8(
    parser_context_t* c, pd_registry_change_program_modification_account_V8_t* m)
{
    CHECK_ERROR(_readVerifyingKey(c, &m->verifying_key))
...
__Z_INLINE parser_error_t _readMethod_programs_set_program_V8(
    parser_context_t* c, pd_programs_set_program_V8_t* m)
{
    ...
    CHECK_ERROR(_readu8(c, &m->version_number))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_programs_remove_program_V8(
    parser_context_t* c, pd_programs_remove_program_V8_t* m)
{
    ...
    pd_Method_V8_t* method)
{
    ...
    case 2816: /* module 11 call 0 */
        CHECK_ERROR(_readMethod_staking_bond_V8(c, &method->nested.staking_bond_V8))
        break;
    case 2817: /* module 11 call 1 */
        CHECK_ERROR(_readMethod_staking_bond_extra_V8(c, &method->nested.staking_bond_extra_V8))
        break;
    case 2818: /* module 11 call 2 */
        CHECK_ERROR(_readMethod_staking_unbond_V8(c, &method->nested.staking_unbond_V8))
        break;
    case 2819: /* module 11 call 3 */
        CHECK_ERROR(_readMethod_staking_withdraw_unbonded_V8(c, &method->nested.staking_withdraw_unbonded_V8))
        break;
    case 2820: /* module 11 call 4 */
        CHECK_ERROR(_readMethod_staking_validate_V8(c, &method->nested.staking_validate_V8))
        break;
    case 2821: /* module 11 call 5 */
        CHECK_ERROR(_readMethod_staking_nominate_V8(c, &method->nested.staking_nominate_V8))
        break;
    case 2822: /* module 11 call 6 */
        CHECK_ERROR(_readMethod_staking_chill_V8(c, &method->nested.staking_chill_V8))
        break;
    case 2823: /* module 11 call 7 */
        CHECK_ERROR(_readMethod_staking_set_payee_V8(c, &method->nested.staking_set_payee_V8))
        break;
    case 2824: /* module 11 call 8 */
        CHECK_ERROR(_readMethod_staking_set_controller_V8(c, &method->nested.staking_set_controller_V8))
        break;
    case 2834: /* module 11 call 18 */
        CHECK_ERROR(_readMethod_staking_payout_stakers_V8(c, &method->nested.staking_payout_stakers_V8))
        break;
    case 2835: /* module 11 call 19 */
        CHECK_ERROR(_readMethod_staking_rebond_V8(c, &method->nested.staking_rebond_V8))
        break;
    case 5120: /* module 20 call 0 */
        CHECK_ERROR(_readMethod_session_set_keys_V8(c, &method->nested.session_set_keys_V8))
        break;
    case 5121: /* module 20 call 1 */
        CHECK_ERROR(_readMethod_session_purge_keys_V8(c, &method->nested.session_purge_keys_V8))
        break;
    ...
    case 265: /* module 1 call 9 */
        CHECK_ERROR(_readMethod_system_authorize_upgrade_V8(c, &method->basic.system_authorize_upgrade_V8))
        break;
    case 266: /* module 1 call 10 */
        CHECK_ERROR(_readMethod_system_authorize_upgrade_without_checks_V8(c, &method->basic.system_authorize_upgrade_without_checks_V8))
        break;
    case 267: /* module 1 call 11 */
        CHECK_ERROR(_readMethod_system_apply_authorized_upgrade_V8(c, &method->basic.system_apply_authorized_upgrade_V8))
        break;
    case 515: /* module 2 call 3 */
        CHECK_ERROR(_readMethod_utility_dispatch_as_V8(c, &method->basic.utility_dispatch_as_V8))
        break;
    ...
    case 1801: /* module 7 call 9 */
        CHECK_ERROR(_readMethod_balances_force_adjust_total_issuance_V8(c, &method->basic.balances_force_adjust_total_issuance_V8))
        break;
    ...
    case 2838: /* module 11 call 22 */
        CHECK_ERROR(_readMethod_staking_set_staking_configs_V8(c, &method->basic.staking_set_staking_configs_V8))
        break;
    ...
    case 2840: /* module 11 call 24 */
        CHECK_ERROR(_readMethod_staking_force_apply_min_commission_V8(c, &method->basic.staking_force_apply_min_commission_V8))
        break;
    case 2841: /* module 11 call 25 */
        CHECK_ERROR(_readMethod_staking_set_min_commission_V8(c, &method->basic.staking_set_min_commission_V8))
        break;
    case 2842: /* module 11 call 26 */
        CHECK_ERROR(_readMethod_staking_payout_stakers_by_page_V8(c, &method->basic.staking_payout_stakers_by_page_V8))
        break;
    case 2843: /* module 11 call 27 */
        CHECK_ERROR(_readMethod_staking_update_payee_V8(c, &method->basic.staking_update_payee_V8))
        break;
    case 2845: /* module 11 call 29 */
        CHECK_ERROR(_readMethod_staking_restore_ledger_V8(c, &method->basic.staking_restore_ledger_V8))
        break;
    case 3072: /* module 12 call 0 */
        CHECK_ERROR(_readMethod_stakingextension_change_endpoint_V8(c, &method->basic.stakingextension_change_endpoint_V8))
        break;
    case 3073: /* module 12 call 1 */
        CHECK_ERROR(_readMethod_stakingextension_change_threshold_accounts_V8(c, &method->basic.stakingextension_change_threshold_accounts_V8))
        break;
    case 3074: /* module 12 call 2 */
        CHECK_ERROR(_readMethod_stakingextension_unbond_V8(c, &method->basic.stakingextension_unbond_V8))
        break;
    case 3075: /* module 12 call 3 */
        CHECK_ERROR(_readMethod_stakingextension_chill_V8(c, &method->basic.stakingextension_chill_V8))
        break;
    case 3076: /* module 12 call 4 */
        CHECK_ERROR(_readMethod_stakingextension_withdraw_unbonded_V8(c, &method->basic.stakingextension_withdraw_unbonded_V8))
        break;
    case 3077: /* module 12 call 5 */
        CHECK_ERROR(_readMethod_stakingextension_validate_V8(c, &method->basic.stakingextension_validate_V8))
        break;
    case 3078: /* module 12 call 6 */
        CHECK_ERROR(_readMethod_stakingextension_declare_synced_V8(c, &method->basic.stakingextension_declare_synced_V8))
        break;
    case 3079: /* module 12 call 7 */
        CHECK_ERROR(_readMethod_stakingextension_confirm_key_reshare_V8(c, &method->basic.stakingextension_confirm_key_reshare_V8))
        break;
    ...
    case 11265: /* module 44 call 1 */
        CHECK_ERROR(_readMethod_proxy_add_proxy_V8(c, &method->nested.proxy_add_proxy_V8))
        break;
    case 11266: /* module 44 call 2 */
        CHECK_ERROR(_readMethod_proxy_remove_proxy_V8(c, &method->nested.proxy_remove_proxy_V8))
        break;
    ...
    case 11268: /* module 44 call 4 */
        CHECK_ERROR(_readMethod_proxy_create_pure_V8(c, &method->nested.proxy_create_pure_V8))
        break;
    case 11269: /* module 44 call 5 */
        CHECK_ERROR(_readMethod_proxy_kill_pure_V8(c, &method->nested.proxy_kill_pure_V8))
        break;
    ...
    case 13056: /* module 51 call 0 */
        CHECK_ERROR(_readMethod_registry_jump_start_network_V8(c, &method->basic.registry_jump_start_network_V8))
        break;
    case 13057: /* module 51 call 1 */
        CHECK_ERROR(_readMethod_registry_confirm_jump_start_V8(c, &method->basic.registry_confirm_jump_start_V8))
        break;
    case 13058: /* module 51 call 2 */
        CHECK_ERROR(_readMethod_registry_register_V8(c, &method->basic.registry_register_V8))
        break;
    case 13059: /* module 51 call 3 */
        CHECK_ERROR(_readMethod_registry_change_program_instance_V8(c, &method->basic.registry_change_program_instance_V8))
        break;
    case 13060: /* module 51 call 4 */
        CHECK_ERROR(_readMethod_registry_change_program_modification_account_V8(c, &method->basic.registry_change_program_modification_account_V8))
        break;
    case 13568: /* module 53 call 0 */
        CHECK_ERROR(_readMethod_programs_set_program_V8(c, &method->basic.programs_set_program_V8))
        break;
    case 13569: /* module 53 call 1 */
        CHECK_ERROR(_readMethod_programs_remove_program_V8(c, &method->basic.programs_remove_program_V8))
        break;
#endif
    default:
...
const char* _getMethod_Name_V8_ParserFull(uint16_t callPrivIdx)
{
    ...
    case 3079: /* module 12 call 7 */
        return STR_ME_CONFIRM_KEY_RESHARE;
    case 11264: /* module 44 call 0 */
        return STR_ME_PROXY;
    case 11265: /* module 44 call 1 */
    ...
    case 13056: /* module 51 call 0 */
        return STR_ME_JUMP_START_NETWORK;
    case 13057: /* module 51 call 1 */
        return STR_ME_CONFIRM_JUMP_START;
    case 13058: /* module 51 call 2 */
    ...
    uint8_t pageIdx, uint8_t* pageCount)
{
    ...
    case 2816: /* module 11 call 0 */
        switch (itemIdx) {
        case 0: /* staking_bond_V8 - amount */;
            return _toStringCompactBalance(
                &m->nested.staking_bond_V8.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* staking_bond_V8 - payee */;
            return _toStringRewardDestination(
                &m->nested.staking_bond_V8.payee,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2817: /* module 11 call 1 */
        ...
        case 0: /* staking_bond_extra_V8 - amount */;
            return _toStringCompactBalance(
                &m->nested.staking_bond_extra_V8.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2818: /* module 11 call 2 */
        ...
        case 0: /* staking_unbond_V8 - amount */;
            return _toStringCompactBalance(
                &m->nested.staking_unbond_V8.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2819: /* module 11 call 3 */
        ...
        case 0: /* staking_withdraw_unbonded_V8 - num_slashing_spans */;
            return _toStringu32(
                &m->nested.staking_withdraw_unbonded_V8.num_slashing_spans,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2820: /* module 11 call 4 */
        ...
        case 0: /* staking_validate_V8 - prefs */;
            return _toStringValidatorPrefs(
                &m->nested.staking_validate_V8.prefs,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2821: /* module 11 call 5 */
        ...
        case 0: /* staking_nominate_V8 - targets */;
            return _toStringVecAccountIdLookupOfT(
                &m->nested.staking_nominate_V8.targets,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2823: /* module 11 call 7 */
        ...
        case 0: /* staking_set_payee_V8 - payee */;
            return _toStringRewardDestination(
                &m->nested.staking_set_payee_V8.payee,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2834: /* module 11 call 18 */
        ...
        case 0: /* staking_payout_stakers_V8 - validator_stash */;
            return _toStringAccountId(
                &m->nested.staking_payout_stakers_V8.validator_stash,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* staking_payout_stakers_V8 - era */;
            return _toStringEraIndex(
                &m->nested.staking_payout_stakers_V8.era,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2835: /* module 11 call 19 */
        ...
        case 0: /* staking_rebond_V8 - amount */;
            return _toStringCompactBalance(
                &m->nested.staking_rebond_V8.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5120: /* module 20 call 0 */
        ...
        case 0: /* session_set_keys_V8 - keys */;
            return _toStringKeys(
                &m->nested.session_set_keys_V8.keys,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* session_set_keys_V8 - proof */;
            return _toStringBytes(
                &m->nested.session_set_keys_V8.proof,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 265: /* module 1 call 9 */
        switch (itemIdx) {
        case 0: /* system_authorize_upgrade_V8 - code_hash */;
            return _toStringHash(
                &m->basic.system_authorize_upgrade_V8.code_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 266: /* module 1 call 10 */
        switch (itemIdx) {
        case 0: /* system_authorize_upgrade_without_checks_V8 - code_hash */;
            return _toStringHash(
                &m->basic.system_authorize_upgrade_without_checks_V8.code_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 267: /* module 1 call 11 */
        switch (itemIdx) {
        case 0: /* system_apply_authorized_upgrade_V8 - code */;
            return _toStringVecu8(
                &m->basic.system_apply_authorized_upgrade_V8.code,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 515: /* module 2 call 3 */
        switch (itemIdx) {
        case 0: /* utility_dispatch_as_V8 - as_origin */;
            return _toStringBoxPalletsOrigin(
                &m->basic.utility_dispatch_as_V8.as_origin,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* utility_dispatch_as_V8 - call */;
            return _toStringCall(
                &m->basic.utility_dispatch_as_V8.call,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1801: /* module 7 call 9 */
        switch (itemIdx) {
        case 0: /* balances_force_adjust_total_issuance_V8 - direction */;
            return _toStringAdjustmentDirection(
                &m->basic.balances_force_adjust_total_issuance_V8.direction,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* balances_force_adjust_total_issuance_V8 - delta */;
            return _toStringCompactBalance(
                &m->basic.balances_force_adjust_total_issuance_V8.delta,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2838: /* module 11 call 22 */
        switch (itemIdx) {
        case 0: /* staking_set_staking_configs_V8 - min_nominator_bond */;
            return _toStringConfigOpBalanceOfT(
                &m->basic.staking_set_staking_configs_V8.min_nominator_bond,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* staking_set_staking_configs_V8 - min_validator_bond */;
            return _toStringConfigOpBalanceOfT(
                &m->basic.staking_set_staking_configs_V8.min_validator_bond,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* staking_set_staking_configs_V8 - max_nominator_count */;
            return _toStringConfigOpu32(
                &m->basic.staking_set_staking_configs_V8.max_nominator_count,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* staking_set_staking_configs_V8 - max_validator_count */;
            return _toStringConfigOpu32(
                &m->basic.staking_set_staking_configs_V8.max_validator_count,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* staking_set_staking_configs_V8 - chill_threshold */;
            return _toStringConfigOpPercent(
                &m->basic.staking_set_staking_configs_V8.chill_threshold,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* staking_set_staking_configs_V8 - min_commission */;
            return _toStringConfigOpPerbill(
                &m->basic.staking_set_staking_configs_V8.min_commission,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2839: /* module 11 call 23 */
        switch (itemIdx) {
        case 0: /* staking_chill_other_V8 - stash */;
            return _toStringAccountId(
                &m->basic.staking_chill_other_V8.stash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2840: /* module 11 call 24 */
        switch (itemIdx) {
        case 0: /* staking_force_apply_min_commission_V8 - validator_stash */;
            return _toStringAccountId(
                &m->basic.staking_force_apply_min_commission_V8.validator_stash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2841: /* module 11 call 25 */
        switch (itemIdx) {
        case 0: /* staking_set_min_commission_V8 - new_ */;
            return _toStringPerbill(
                &m->basic.staking_set_min_commission_V8.new_,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2842: /* module 11 call 26 */
        switch (itemIdx) {
        case 0: /* staking_payout_stakers_by_page_V8 - validator_stash */;
            return _toStringAccountId(
                &m->basic.staking_payout_stakers_by_page_V8.validator_stash,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* staking_payout_stakers_by_page_V8 - era */;
            return _toStringEraIndex(
                &m->basic.staking_payout_stakers_by_page_V8.era,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* staking_payout_stakers_by_page_V8 - page */;
            return _toStringPage(
                &m->basic.staking_payout_stakers_by_page_V8.page,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2843: /* module 11 call 27 */
        switch (itemIdx) {
        case 0: /* staking_update_payee_V8 - controller */;
            return _toStringAccountId(
                &m->basic.staking_update_payee_V8.controller,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2845: /* module 11 call 29 */
        switch (itemIdx) {
        case 0: /* staking_restore_ledger_V8 - stash */;
            return _toStringAccountId(
                &m->basic.staking_restore_ledger_V8.stash,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* staking_restore_ledger_V8 - maybe_controller */;
            return _toStringOptionAccountId(
                &m->basic.staking_restore_ledger_V8.maybe_controller,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* staking_restore_ledger_V8 - maybe_total */;
            return _toStringOptionBalance(
                &m->basic.staking_restore_ledger_V8.maybe_total,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* staking_restore_ledger_V8 - maybe_unlocking */;
            return _toStringOptionBoundedVecUnlockChunkBalanceOfTMaxUnlockingChunks(
                &m->basic.staking_restore_ledger_V8.maybe_unlocking,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3072: /* module 12 call 0 */
        switch (itemIdx) {
        case 0: /* stakingextension_change_endpoint_V8 - endpoint */;
            return _toStringVecu8(
                &m->basic.stakingextension_change_endpoint_V8.endpoint,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3073: /* module 12 call 1 */
        switch (itemIdx) {
        case 0: /* stakingextension_change_threshold_accounts_V8 - tss_account */;
            return _toStringAccountId(
                &m->basic.stakingextension_change_threshold_accounts_V8.tss_account,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* stakingextension_change_threshold_accounts_V8 - x25519_public_key */;
            return _toStringX25519PublicKey(
                &m->basic.stakingextension_change_threshold_accounts_V8.x25519_public_key,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3074: /* module 12 call 2 */
        switch (itemIdx) {
        case 0: /* stakingextension_unbond_V8 - amount */;
            return _toStringCompactu128(
                &m->basic.stakingextension_unbond_V8.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3076: /* module 12 call 4 */
        switch (itemIdx) {
        case 0: /* stakingextension_withdraw_unbonded_V8 - num_slashing_spans */;
            return _toStringu32(
                &m->basic.stakingextension_withdraw_unbonded_V8.num_slashing_spans,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3077: /* module 12 call 5 */
        switch (itemIdx) {
        case 0: /* stakingextension_validate_V8 - prefs */;
            return _toStringValidatorPrefs(
                &m->basic.stakingextension_validate_V8.prefs,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* stakingextension_validate_V8 - server_info */;
            return _toStringServerInfoAccountId(
                &m->basic.stakingextension_validate_V8.server_info,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3078: /* module 12 call 6 */
        switch (itemIdx) {
        case 0: /* stakingextension_declare_synced_V8 - synced */;
            return _toStringbool(
                &m->basic.stakingextension_declare_synced_V8.synced,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11265: /* module 44 call 1 */
        ...
        case 0: /* proxy_add_proxy_V8 - delegate */;
            return _toStringAccountIdLookupOfT(
                &m->nested.proxy_add_proxy_V8.delegate,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* proxy_add_proxy_V8 - proxy_type */;
            return _toStringProxyType(
                &m->nested.proxy_add_proxy_V8.proxy_type,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* proxy_add_proxy_V8 - delay */;
            return _toStringBlockNumber(
                &m->nested.proxy_add_proxy_V8.delay,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11266: /* module 44 call 2 */
        ...
        case 0: /* proxy_remove_proxy_V8 - delegate */;
            return _toStringAccountIdLookupOfT(
                &m->nested.proxy_remove_proxy_V8.delegate,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* proxy_remove_proxy_V8 - proxy_type */;
            return _toStringProxyType(
                &m->nested.proxy_remove_proxy_V8.proxy_type,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* proxy_remove_proxy_V8 - delay */;
            return _toStringBlockNumber(
                &m->nested.proxy_remove_proxy_V8.delay,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11268: /* module 44 call 4 */
        switch (itemIdx) {
        case 0: /* proxy_create_pure_V8 - proxy_type */;
            return _toStringProxyType(
                &m->nested.proxy_create_pure_V8.proxy_type,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* proxy_create_pure_V8 - delay */;
            return _toStringBlockNumber(
                &m->nested.proxy_create_pure_V8.delay,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* proxy_create_pure_V8 - index */;
            return _toStringu16(
                &m->nested.proxy_create_pure_V8.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11269: /* module 44 call 5 */
        switch (itemIdx) {
        case 0: /* proxy_kill_pure_V8 - spawner */;
            return _toStringAccountIdLookupOfT(
                &m->nested.proxy_kill_pure_V8.spawner,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* proxy_kill_pure_V8 - proxy_type */;
            return _toStringProxyType(
                &m->nested.proxy_kill_pure_V8.proxy_type,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* proxy_kill_pure_V8 - index */;
            return _toStringu16(
                &m->nested.proxy_kill_pure_V8.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* proxy_kill_pure_V8 - height */;
            return _toStringCompactu32(
                &m->nested.proxy_kill_pure_V8.height,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* proxy_kill_pure_V8 - ext_index */;
            return _toStringCompactu32(
                &m->nested.proxy_kill_pure_V8.ext_index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 13057: /* module 51 call 1 */
        switch (itemIdx) {
        case 0: /* registry_confirm_jump_start_V8 - verifying_key */;
            return _toStringVerifyingKey(
                &m->basic.registry_confirm_jump_start_V8.verifying_key,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 13058: /* module 51 call 2 */
        switch (itemIdx) {
        case 0: /* registry_register_V8 - program_modification_account */;
            return _toStringAccountId(
                &m->basic.registry_register_V8.program_modification_account,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* registry_register_V8 - programs_data */;
            return _toStringBoundedVecProgramInstanceTMaxProgramHashes(
                &m->basic.registry_register_V8.programs_data,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 13059: /* module 51 call 3 */
        switch (itemIdx) {
        case 0: /* registry_change_program_instance_V8 - verifying_key */;
            return _toStringVerifyingKey(
                &m->basic.registry_change_program_instance_V8.verifying_key,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* registry_change_program_instance_V8 - new_program_instance */;
            return _toStringBoundedVecProgramInstanceTMaxProgramHashes(
                &m->basic.registry_change_program_instance_V8.new_program_instance,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 13060: /* module 51 call 4 */
        switch (itemIdx) {
        case 0: /* registry_change_program_modification_account_V8 - verifying_key */;
            return _toStringVerifyingKey(
                &m->basic.registry_change_program_modification_account_V8.verifying_key,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* registry_change_program_modification_account_V8 - new_program_mod_account */;
            return _toStringAccountId(
                &m->basic.registry_change_program_modification_account_V8.new_program_mod_account,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 13568: /* module 53 call 0 */
        switch (itemIdx) {
        case 0: /* programs_set_program_V8 - new_program */;
            return _toStringVecu8(
                &m->basic.programs_set_program_V8.new_program,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* programs_set_program_V8 - configuration_schema */;
            return _toStringVecu8(
                &m->basic.programs_set_program_V8.configuration_schema,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* programs_set_program_V8 - auxiliary_data_schema */;
            return _toStringVecu8(
                &m->basic.programs_set_program_V8.auxiliary_data_schema,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* programs_set_program_V8 - oracle_data_pointer */;
            return _toStringVecu8(
                &m->basic.programs_set_program_V8.oracle_data_pointer,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* programs_set_program_V8 - version_number */;
            return _toStringu8(
                &m->basic.programs_set_program_V8.version_number,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 13569: /* module 53 call 1 */
        switch (itemIdx) {
        case 0: /* programs_remove_program_V8 - program_hash */;
            return _toStringHash(
                &m->basic.programs_remove_program_V8.program_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
...
bool _getMethod_ItemIsExpert_V8(uint8_t moduleIdx, uint8_t callIdx, __Z_UNUSED uint8_t itemIdx)
{
    ...
    case 3076: // StakingExtension:Withdraw Unbonded
        switch (itemIdx) {
        case 0: // Num slashing spans
            return true;
        default:
...
bool _getMethod_IsNestingSupported_V8(uint8_t moduleIdx, uint8_t callIdx)
{
    ...
    case 3074: // StakingExtension:Unbond
    case 3075: // StakingExtension:Chill
    case 3076: // StakingExtension:Withdraw Unbonded
    case 3077: // StakingExtension:Validate
    case 3078: // StakingExtension:Declare synced
    case 3079: // StakingExtension:Confirm key reshare
    ...
    case 13056: // Registry:Jump start network
    case 13057: // Registry:Confirm jump start
    case 13058: // Registry:Register
    case 13059: // Registry:Change program instance
    case 13060: // Registry:Change program modification account
