...
__Z_INLINE parser_error_t _readMethod_utility_force_batch_V6(
    parser_context_t* c, pd_utility_force_batch_V6_t* m)
{
    CHECK_ERROR(_readVecCall(c, &m->calls))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_balances_transfer_allow_death_V6(
    parser_context_t* c, pd_balances_transfer_allow_death_V6_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_system_authorize_upgrade_V6(
    parser_context_t* c, pd_system_authorize_upgrade_V6_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_system_apply_authorized_upgrade_V6(
    parser_context_t* c, pd_system_apply_authorized_upgrade_V6_t* m)
{
    CHECK_ERROR(_readVecu8(c, &m->code))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_utility_dispatch_as_V6(
    parser_context_t* c, pd_utility_dispatch_as_V6_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_utility_with_weight_V6(
    parser_context_t* c, pd_utility_with_weight_V6_t* m)
{
    CHECK_ERROR(_readCall(c, &m->call))
...
__Z_INLINE parser_error_t _readMethod_balances_upgrade_accounts_V6(
    parser_context_t* c, pd_balances_upgrade_accounts_V6_t* m)
{
    CHECK_ERROR(_readVecAccountId(c, &m->who))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_balances_force_set_balance_V6(
    parser_context_t* c, pd_balances_force_set_balance_V6_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->who))
...
__Z_INLINE parser_error_t _readMethod_balances_force_adjust_total_issuance_V6(
    parser_context_t* c, pd_balances_force_adjust_total_issuance_V6_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_staking_set_staking_configs_V6(
    parser_context_t* c, pd_staking_set_staking_configs_V6_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_staking_force_apply_min_commission_V6(
    parser_context_t* c, pd_staking_force_apply_min_commission_V6_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->validator_stash))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_staking_set_min_commission_V6(
    parser_context_t* c, pd_staking_set_min_commission_V6_t* m)
{
    CHECK_ERROR(_readPerbill(c, &m->new_))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_staking_payout_stakers_by_page_V6(
    parser_context_t* c, pd_staking_payout_stakers_by_page_V6_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->validator_stash))
    CHECK_ERROR(_readEraIndex(c, &m->era))
...
__Z_INLINE parser_error_t _readMethod_staking_update_payee_V6(
    parser_context_t* c, pd_staking_update_payee_V6_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_stakingextension_withdraw_unbonded_V6(
    parser_context_t* c, pd_stakingextension_withdraw_unbonded_V6_t* m)
{
    CHECK_ERROR(_readu32(c, &m->num_slashing_spans))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_stakingextension_validate_V6(
    parser_context_t* c, pd_stakingextension_validate_V6_t* m)
{
    CHECK_ERROR(_readValidatorPrefs(c, &m->prefs))
...
__Z_INLINE parser_error_t _readMethod_stakingextension_declare_synced_V6(
    parser_context_t* c, pd_stakingextension_declare_synced_V6_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_proxy_create_pure_V6(
    parser_context_t* c, pd_proxy_create_pure_V6_t* m)
{
    CHECK_ERROR(_readProxyType(c, &m->proxy_type))
    CHECK_ERROR(_readBlockNumber(c, &m->delay))
...
__Z_INLINE parser_error_t _readMethod_proxy_kill_pure_V6(
    parser_context_t* c, pd_proxy_kill_pure_V6_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_programs_set_program_V6(
    parser_context_t* c, pd_programs_set_program_V6_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_programs_remove_program_V6(
    parser_context_t* c, pd_programs_remove_program_V6_t* m)
{
    ...
    pd_Method_V6_t* method)
{
    ...
    case 266: /* module 1 call 10 */
        CHECK_ERROR(_readMethod_system_authorize_upgrade_without_checks_V6(c, &method->basic.system_authorize_upgrade_without_checks_V6))
        break;
    ...
    case 1801: /* module 7 call 9 */
        CHECK_ERROR(_readMethod_balances_force_adjust_total_issuance_V6(c, &method->basic.balances_force_adjust_total_issuance_V6))
        break;
    ...
    case 2840: /* module 11 call 24 */
        CHECK_ERROR(_readMethod_staking_force_apply_min_commission_V6(c, &method->basic.staking_force_apply_min_commission_V6))
        break;
    ...
    case 3073: /* module 12 call 1 */
        CHECK_ERROR(_readMethod_stakingextension_change_threshold_accounts_V6(c, &method->basic.stakingextension_change_threshold_accounts_V6))
        break;
    case 3074: /* module 12 call 2 */
        CHECK_ERROR(_readMethod_stakingextension_withdraw_unbonded_V6(c, &method->basic.stakingextension_withdraw_unbonded_V6))
        break;
    ...
    uint8_t pageIdx, uint8_t* pageCount)
{
    ...
    case 516: /* module 2 call 4 */
        ...
        case 0: /* utility_force_batch_V6 - calls */;
            return _toStringVecCall(
                &m->basic.utility_force_batch_V6.calls,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1792: /* module 7 call 0 */
        ...
        case 0: /* balances_transfer_allow_death_V6 - dest */;
            return _toStringAccountIdLookupOfT(
                &m->nested.balances_transfer_allow_death_V6.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* balances_transfer_allow_death_V6 - amount */;
            return _toStringCompactBalance(
                &m->nested.balances_transfer_allow_death_V6.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1796: /* module 7 call 4 */
        ...
        case 0: /* balances_transfer_all_V6 - dest */;
            return _toStringAccountIdLookupOfT(
                &m->nested.balances_transfer_all_V6.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* balances_transfer_all_V6 - keep_alive */;
            return _toStringbool(
                &m->nested.balances_transfer_all_V6.keep_alive,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2816: /* module 11 call 0 */
        ...
        case 0: /* staking_bond_V6 - amount */;
            return _toStringCompactBalance(
                &m->nested.staking_bond_V6.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
    ...
    case 2817: /* module 11 call 1 */
        ...
        case 0: /* staking_bond_extra_V6 - amount */;
            return _toStringCompactBalance(
                &m->nested.staking_bond_extra_V6.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2818: /* module 11 call 2 */
        ...
        case 0: /* staking_unbond_V6 - amount */;
            return _toStringCompactBalance(
                &m->nested.staking_unbond_V6.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2835: /* module 11 call 19 */
        ...
        case 0: /* staking_rebond_V6 - amount */;
            return _toStringCompactBalance(
                &m->nested.staking_rebond_V6.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 265: /* module 1 call 9 */
        ...
        case 0: /* system_authorize_upgrade_V6 - code_hash */;
            return _toStringHash(
                &m->basic.system_authorize_upgrade_V6.code_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 266: /* module 1 call 10 */
        ...
        case 0: /* system_authorize_upgrade_without_checks_V6 - code_hash */;
            return _toStringHash(
                &m->basic.system_authorize_upgrade_without_checks_V6.code_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 267: /* module 1 call 11 */
        ...
        case 0: /* system_apply_authorized_upgrade_V6 - code */;
            return _toStringVecu8(
                &m->basic.system_apply_authorized_upgrade_V6.code,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 515: /* module 2 call 3 */
        ...
        case 0: /* utility_dispatch_as_V6 - as_origin */;
            return _toStringBoxPalletsOrigin(
                &m->basic.utility_dispatch_as_V6.as_origin,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* utility_dispatch_as_V6 - call */;
            return _toStringCall(
                &m->basic.utility_dispatch_as_V6.call,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 517: /* module 2 call 5 */
        ...
        case 0: /* utility_with_weight_V6 - call */;
            return _toStringCall(
                &m->basic.utility_with_weight_V6.call,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* utility_with_weight_V6 - weight */;
            return _toStringWeight(
                &m->basic.utility_with_weight_V6.weight,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1798: /* module 7 call 6 */
        ...
        case 0: /* balances_upgrade_accounts_V6 - who */;
            return _toStringVecAccountId(
                &m->basic.balances_upgrade_accounts_V6.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1800: /* module 7 call 8 */
        ...
        case 0: /* balances_force_set_balance_V6 - who */;
            return _toStringAccountIdLookupOfT(
                &m->basic.balances_force_set_balance_V6.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* balances_force_set_balance_V6 - new_free */;
            return _toStringCompactBalance(
                &m->basic.balances_force_set_balance_V6.new_free,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1801: /* module 7 call 9 */
        ...
        case 0: /* balances_force_adjust_total_issuance_V6 - direction */;
            return _toStringAdjustmentDirection(
                &m->basic.balances_force_adjust_total_issuance_V6.direction,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* balances_force_adjust_total_issuance_V6 - delta */;
            return _toStringCompactBalance(
                &m->basic.balances_force_adjust_total_issuance_V6.delta,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2839: /* module 11 call 23 */
        ...
        case 0: /* staking_chill_other_V6 - stash */;
            return _toStringAccountId(
                &m->basic.staking_chill_other_V6.stash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2840: /* module 11 call 24 */
        ...
        case 0: /* staking_force_apply_min_commission_V6 - validator_stash */;
            return _toStringAccountId(
                &m->basic.staking_force_apply_min_commission_V6.validator_stash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2841: /* module 11 call 25 */
        ...
        case 0: /* staking_set_min_commission_V6 - new_ */;
            return _toStringPerbill(
                &m->basic.staking_set_min_commission_V6.new_,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2842: /* module 11 call 26 */
        ...
        case 0: /* staking_payout_stakers_by_page_V6 - validator_stash */;
            return _toStringAccountId(
                &m->basic.staking_payout_stakers_by_page_V6.validator_stash,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* staking_payout_stakers_by_page_V6 - era */;
            return _toStringEraIndex(
                &m->basic.staking_payout_stakers_by_page_V6.era,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* staking_payout_stakers_by_page_V6 - page */;
            return _toStringPage(
                &m->basic.staking_payout_stakers_by_page_V6.page,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 2843: /* module 11 call 27 */
        ...
        case 0: /* staking_update_payee_V6 - controller */;
            return _toStringAccountId(
                &m->basic.staking_update_payee_V6.controller,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3072: /* module 12 call 0 */
        ...
        case 0: /* stakingextension_change_endpoint_V6 - endpoint */;
            return _toStringVecu8(
                &m->basic.stakingextension_change_endpoint_V6.endpoint,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3073: /* module 12 call 1 */
        ...
        case 0: /* stakingextension_change_threshold_accounts_V6 - tss_account */;
            return _toStringAccountId(
                &m->basic.stakingextension_change_threshold_accounts_V6.tss_account,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* stakingextension_change_threshold_accounts_V6 - x25519_public_key */;
            return _toStringX25519PublicKey(
                &m->basic.stakingextension_change_threshold_accounts_V6.x25519_public_key,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3074: /* module 12 call 2 */
        ...
        case 0: /* stakingextension_withdraw_unbonded_V6 - num_slashing_spans */;
            return _toStringu32(
                &m->basic.stakingextension_withdraw_unbonded_V6.num_slashing_spans,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3075: /* module 12 call 3 */
        ...
        case 0: /* stakingextension_validate_V6 - prefs */;
            return _toStringValidatorPrefs(
                &m->basic.stakingextension_validate_V6.prefs,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* stakingextension_validate_V6 - server_info */;
            return _toStringServerInfoAccountId(
                &m->basic.stakingextension_validate_V6.server_info,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3076: /* module 12 call 4 */
        ...
        case 0: /* stakingextension_declare_synced_V6 - synced */;
            return _toStringbool(
                &m->basic.stakingextension_declare_synced_V6.synced,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11265: /* module 44 call 1 */
        ...
        case 0: /* proxy_add_proxy_V6 - delegate */;
            return _toStringAccountIdLookupOfT(
                &m->nested.proxy_add_proxy_V6.delegate,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* proxy_add_proxy_V6 - proxy_type */;
            return _toStringProxyType(
                &m->nested.proxy_add_proxy_V6.proxy_type,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* proxy_add_proxy_V6 - delay */;
            return _toStringBlockNumber(
                &m->nested.proxy_add_proxy_V6.delay,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11266: /* module 44 call 2 */
        ...
        case 0: /* proxy_remove_proxy_V6 - delegate */;
            return _toStringAccountIdLookupOfT(
                &m->nested.proxy_remove_proxy_V6.delegate,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* proxy_remove_proxy_V6 - proxy_type */;
            return _toStringProxyType(
                &m->nested.proxy_remove_proxy_V6.proxy_type,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* proxy_remove_proxy_V6 - delay */;
            return _toStringBlockNumber(
                &m->nested.proxy_remove_proxy_V6.delay,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11268: /* module 44 call 4 */
        ...
        case 0: /* proxy_create_pure_V6 - proxy_type */;
            return _toStringProxyType(
                &m->nested.proxy_create_pure_V6.proxy_type,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* proxy_create_pure_V6 - delay */;
            return _toStringBlockNumber(
                &m->nested.proxy_create_pure_V6.delay,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* proxy_create_pure_V6 - index */;
            return _toStringu16(
                &m->nested.proxy_create_pure_V6.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11269: /* module 44 call 5 */
        ...
        case 0: /* proxy_kill_pure_V6 - spawner */;
            return _toStringAccountIdLookupOfT(
                &m->nested.proxy_kill_pure_V6.spawner,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* proxy_kill_pure_V6 - proxy_type */;
            return _toStringProxyType(
                &m->nested.proxy_kill_pure_V6.proxy_type,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* proxy_kill_pure_V6 - index */;
            return _toStringu16(
                &m->nested.proxy_kill_pure_V6.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* proxy_kill_pure_V6 - height */;
            return _toStringCompactu32(
                &m->nested.proxy_kill_pure_V6.height,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* proxy_kill_pure_V6 - ext_index */;
            return _toStringCompactu32(
                &m->nested.proxy_kill_pure_V6.ext_index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 13568: /* module 53 call 0 */
        ...
        case 0: /* programs_set_program_V6 - new_program */;
            return _toStringVecu8(
                &m->basic.programs_set_program_V6.new_program,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* programs_set_program_V6 - configuration_schema */;
            return _toStringVecu8(
                &m->basic.programs_set_program_V6.configuration_schema,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* programs_set_program_V6 - auxiliary_data_schema */;
            return _toStringVecu8(
                &m->basic.programs_set_program_V6.auxiliary_data_schema,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* programs_set_program_V6 - oracle_data_pointer */;
            return _toStringVecu8(
                &m->basic.programs_set_program_V6.oracle_data_pointer,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 13569: /* module 53 call 1 */
        ...
        case 0: /* programs_remove_program_V6 - program_hash */;
            return _toStringHash(
                &m->basic.programs_remove_program_V6.program_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
